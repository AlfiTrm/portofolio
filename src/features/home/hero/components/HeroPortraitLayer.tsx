      ...
      >
        <motion.div className="absolute inset-0" style={{ opacity: colorOpacity }}>
          <Image
            ...
            className="object-contain object-bottom md:object-top [filter:brightness(0.9)_sepia(0.18)_saturate(0.82)_contrast(0.94)]"
          />
        </motion.div>
        <motion.div
        ...
        >
          <Image
            ...
            fill
            sizes="(min-width: 768px) 76vw, 145vw"
            className="object-contain object-bottom md:object-top [filter:brightness(0.94)_grayscale(1)_sepia(0.04)_saturate(0.72)_contrast(1)]"
          />
        </motion.div>
      </motion.div>
